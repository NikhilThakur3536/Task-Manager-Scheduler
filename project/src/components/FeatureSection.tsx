...
export const FeatureSection:React.FC<props>=({position})=>{
    return(
        ...
        <div className="w-[80%] h-[60%] flex">
            ...
            <div className="relative w-[50%] h-[90%] bg-slate-100 border border-slate-300/60 rounded-xl">
                <GridBG size={"14px_14px"} radius={"1px"}/>
            </div>
        </div>:
        <div className="w-[80%] h-[60%] flex">
            <div className="relative w-[50%] bg-slate-100 border border-slate-300/60 rounded-xl">
                <GridBG size={"14px_14px"} radius={"1px"}/>
            </div>
            <div className=" flex flex-col  w-[50%] mt-12 ">
